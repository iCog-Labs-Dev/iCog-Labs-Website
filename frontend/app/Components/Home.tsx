...
<section className="relative bg-gradient-to-r from-orange-100 to-white min-h-screen flex items-center">
  <div className="container mx-auto flex flex-col-reverse md:flex-row items-center justify-between py-16 px-8">
    ...
    <Image
      ...
      <a href="#" className="mt-6 inline-block text-lg text-orange-600 underline hover:no-underline">
        Read Our Latest &gt;
      </a>
    </div>

    {/* Right VR Image - Reduced Size */}
    <div className="relative w-full md:w-1/3 flex justify-center">
      <div className="relative">
        ...
        <div className="absolute bottom-0 left-0 w-full h-24 bg-gradient-to-t from-orange-100 to-transparent"></div>
      </div>
    </div>
...
<section className="py-16 bg-white">
  <div className="container mx-auto px-4">
    ...
    <p className="text-center text-gray-600 mb-12">
      At iCog Labs, we advance AI research and development, driving innovation 
      in robotics, machine learning, and more, to transform industries and improve lives globally.
    </p>
