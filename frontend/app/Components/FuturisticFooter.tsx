...
export default function FuturisticFooter() {
  ...
  return (
    <footer className="relative overflow-hidden bg-black border-t border-gray-800">
      ...
      <section className="py-24 relative">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <motion.p className="mb-8 text-lg text-gray-400" variants={fadeInUp}>
            ...
            <motion.div variants={fadeInUp} className="relative inline-block">
              ...
              {/* Decorative elements */}
              <motion.div
                className="absolute -z-10 -top-6 -left-6 w-16 h-16 rounded-full bg-orange-500/10"
                animate={{
                  scale: [1, 1.2, 1],
                  opacity: [0.7, 0.9, 0.7],
                }}
              ...
              <motion.div
                className="absolute -z-10 -bottom-6 -right-6 w-24 h-24 rounded-full bg-red-500/10"
                animate={{
                  scale: [1, 1.3, 1],
                  opacity: [0.5, 0.8, 0.5],
                }}
      ...
      {/* Main Footer Section */}
      <div className="bg-black text-white pt-16 pb-8 relative border-t border-gray-800">
