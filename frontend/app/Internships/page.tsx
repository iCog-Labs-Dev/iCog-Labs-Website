  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      if (dataResponse.status !== 200 && dataResponse.status !== 201) {
        throw new Error(
          dataResponse.data.message || "Failed to submit application data"
        );
      }
    ...
    return (
      <div className="bg-gray-950 min-h-screen flex items-center justify-center py-28">
        ...
        >
          ...
          >
            Thank you for applying to our internship program. We've received
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Premier program designed to train and develop exceptional talent
              through extensive hands-on experience in cutting-edge technologies
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-400 mb-8">
              Complete all required fields to apply for the internship program
            </p>
                      ...
                      <div>
                        ...
                        {errors.ApplicantFullName && (
                          <p className="mt-1 text-sm text-red-500">
                            {String(errors.ApplicantFullName.message)}
                          </p>
                        )}
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <label className="block text-sm font-mediumplaces text-gray-300 mb-1">
                          Have you taken any online courses in AI, ML, or
                          related fields?
                        </label>
                        <div className="flex gap-6 mt-2">
                          <label className="flex items-center">
                      ...
                      <div className="md:col-span-2">
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                          {watch("OpportunityReason")?.length || 0} characters
                        </p>
                      </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-400 mb-8">
              ...
              <span className="text-orange-400">internships@icoglabs.com</span>
            </p>
            <a
