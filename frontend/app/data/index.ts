  ...
  export const sec1Data = [
    {
      ...
      title: "Our Mission",
      description:
        "To advance artificial general intelligence research and create cognitive systems that augment human capabilities, solve complex problems, and drive innovation across industries.",
    },
    {
      id: 2,
      title: "Our Vision",
      description:
        "A world where intelligent systems work seamlessly with humans, enhancing our collective potential and addressing humanity's greatest challenges through advanced cognitive computing.",
    },
    {
      id: 3,
      title: "Advancing AI Research",
      description: "Our team of researchers and engineers work at the cutting edge of machine learning, neural networks, and cognitive systems.",
      img: "/VR.png",
    },
  ];
