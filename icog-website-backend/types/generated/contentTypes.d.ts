...
export interface ApiInternshipApplicationInternshipApplication
  ...
  attributes: {
    ApplicantEmail: Attribute.Email & Attribute.Required;
    ApplicantFullName: Attribute.String & Attribute.Required;
    ApplicantPhone: Attribute.String;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
    ...
    CurrentStatus: Attribute.Enumeration<
      ['Submitted', 'Under Review', 'Interviewing', 'Rejected', 'Accepted']
    > &
    ...
    GitHubAccount: Attribute.String;
    HasTakenOnlineCourses: Attribute.Boolean;
    internship: Attribute.Relation<
      'api::internship-application.internship-application',
      'oneToOne',
      'api::internship.internship'
    >;
    MindplaxAccount: Attribute.String;
    OpportunityReason: Attribute.Text;
    PromisedHours: Attribute.String;
    publishedAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::internship-application.internship-application',
...
export interface ApiInternshipInternship extends Schema.CollectionType {
  ...
  attributes: {
    CompanyName: Attribute.String & Attribute.DefaultTo<'ICog Labs'>;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::internship.internship',
      'oneToOne',
    ...
    publishedAt: Attribute.DateTime;
    SkillsRequired: Attribute.Text;
    Slug: Attribute.UID<'api::internship.internship', 'Title'>;
